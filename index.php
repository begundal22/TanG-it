...
$tb_barang = query("SELECT * FROM tbl_barang WHERE nama LIKE '%sayur%' LIMIT 3");
...
.close:hover, .close:focus {
  ...
  <body>
    ...
    <div class="bs-callout bs-callout-primary">
      <h4>TanG-it</h4>
      <p>
          Kami adalah penyedia sayur online terlengkap dan terpercaya, dengan harga terjangkau anda sudah dapat memiliki produk kami. Selamat Berbelanja Customer..
        </p>
    </div>
